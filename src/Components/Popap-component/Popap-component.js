...
import s from "./Popap-component.module.css";





let  Popap__component = () => {
    return (
      <div className ={s.wrapper__popap__component}>

<div class="container">
        <div class="row">
            <div class="col-xl-12 d-flex justify-content-center">
                <button className = {s.main__button}><i class="fas fa-plus"></i></button>
            </div>
        </div>
    </div>
  ...
  export default Popap__component;